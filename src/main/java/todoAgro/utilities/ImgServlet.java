...
import controller.todoAgro.ProductoController;
...
public class ImgServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    	LOG.info("todoAgro.utilities.ImgServlet.doGet()");
        String archivoNombre = request.getPathInfo().substring(1);
        if (!archivoNombre.isEmpty()) {
            File carpeta = new File("C:\\todoAgro\\productos\\imgs\\" + archivoNombre);
            ...
            try {
            	...
            	LOG.error("todoAgro.utilities.ImgServlet.doGet() :: " + e.getMessage());
            }
