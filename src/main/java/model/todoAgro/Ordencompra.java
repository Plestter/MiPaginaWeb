...
@NamedQueries({
    ...
    @NamedQuery(name = "Ordencompra.findByOdcOrdencompraid", query = "SELECT o FROM Ordencompra o WHERE o.odcOrdencompraid = :odcOrdencompraid"),
    @NamedQuery(name = "Ordencompra.findByOdcOrdennumero", query = "SELECT o FROM Ordencompra o WHERE o.odcOrdennumero = :odcOrdennumero"),
    @NamedQuery(name = "Ordencompra.findByOdcCatidad", query = "SELECT o FROM Ordencompra o WHERE o.odcCatidad = :odcCatidad"),
    @NamedQuery(name = "Ordencompra.findByOdcValorcompra", query = "SELECT o FROM Ordencompra o WHERE o.odcValorcompra = :odcValorcompra"),
    @NamedQuery(name = "Ordencompra.findByOdcNovedad", query = "SELECT o FROM Ordencompra o WHERE o.odcNovedad = :odcNovedad"),
    @NamedQuery(name = "Ordencompra.findByOdcFechaIngreso", query = "SELECT o FROM Ordencompra o WHERE o.odcFechaIngreso = :odcFechaIngreso")})
public class Ordencompra implements Serializable {
    ...
    public String toString() {
        return "model.todoAgro.Ordencompra[ odcOrdencompraid=" + odcOrdencompraid + " ]";
    }
