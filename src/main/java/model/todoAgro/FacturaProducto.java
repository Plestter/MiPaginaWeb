...
@NamedQueries({
    ...
    @NamedQuery(name = "FacturaProducto.findByFptFacturaproductoid", query = "SELECT f FROM FacturaProducto f WHERE f.fptFacturaproductoid = :fptFacturaproductoid"),
    @NamedQuery(name = "FacturaProducto.findByFptValorunidad", query = "SELECT f FROM FacturaProducto f WHERE f.fptValorunidad = :fptValorunidad"),
    @NamedQuery(name = "FacturaProducto.findByFptCantidad", query = "SELECT f FROM FacturaProducto f WHERE f.fptCantidad = :fptCantidad")})
public class FacturaProducto implements Serializable {
    ...
    public String toString() {
        return "model.todoAgro.FacturaProducto[ fptFacturaproductoid=" + fptFacturaproductoid + " ]";
    }
